    ...
    if (resp.toLowerCase() == Solution[i][j]) 
      {
            ...
            //file.text.value = ('acertosP: '+ acertosP);
...
file.text.value =  'the sound of ed for ' + verb[i][j] +' \n';
var textarea = document.getElementById('textarea');
...
function check(ans)
{
	...
	//alert ('id_of_bt[4] = ' + arrayChars[4] + 'id_of_bt[5] ' + arrayChars[5] + 'ans '+ans );
